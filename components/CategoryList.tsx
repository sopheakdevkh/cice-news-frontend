...
export default function CategoryList({
  ...
  // 4-Column Category Showcase (Homepage Image 1)
  if (variant === 'showcase') {
    return (
      <section className="my-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 -mx-4 lg:-mx-5">
          {articles.map((item, idx) => (
            ...
            >
              {/* Category Header with bold bar centered on thin solid line */}
              <div className="mb-3">
                <div className="flex items-end">
                  <div className="inline-block">
                    <Link
                      href={`/${lang}/category/${item.categorySlug}`}
  ...
  // 2-Column Category Feed (Category Page Mockup)
  return (
    <div className="space-y-6">
      <div className="space-y-6">
        {articles.map((article) => (
          ...
          >
            {/* Article Thumbnail with sharp corners (Larger size) */}
            <Link
            ...
            {/* Article Info: Title + Date (Clean, matching mockup) */}
