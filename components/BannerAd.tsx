...
export default function BannerAd({ variant = 'leaderboard', className = '' }: BannerAdProps) {
  if (variant === 'ad-city') {
    return (
      ...
      >
        ...
        {/* City Skyline Photo (Much bigger size with seamless gradient blend) */}
  ...
  if (variant === 'ad-partner') {
    return (
      ...
      >
        ...
        {/* Angkor Wat Photo (Much bigger size with seamless gold blend) */}
        <div className="absolute right-0 top-0 bottom-0 w-[58%] sm:w-[62%] md:w-[65%] pointer-events-none overflow-hidden">
          <img
  ...
  if (variant === 'ad-globe') {
    return (
      ...
      >
        ...
        {/* Glowing Earth Globe Photo (Much bigger size with seamless fade) */}
        <div className="absolute right-0 top-0 bottom-0 w-[58%] sm:w-[62%] md:w-[65%] pointer-events-none overflow-hidden">
          <img
  ...
  // Exact 100% Match Leaderboard Banner using official /public/advertisement.png asset
  return (
    <div
    ...
    >
      {/* Background Banner Image matching public/advertisement.png / avertiment.png */}
      ...
      {/* 100% Dead-Center Text across the entire banner */}
